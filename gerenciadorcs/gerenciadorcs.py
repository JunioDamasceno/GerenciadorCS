...
diretorio = pathlib.Path('/snap/gerenciadorcs/current/glade')
...
class main_window:
    ...
    def __init__(self):
        ...
        #/snap/gerenciadorcs/current/glade/interface.glade
    ...
    def on_botao_exibir_clicked(self, object, data=None):
        ...
        #Coloca a lista que será exibida em ordem alfanumérica
        self.tabela_ux.sort()
