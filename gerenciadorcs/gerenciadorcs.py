...
class main_window:
    ...
    def __init__(self):
        ...
        while (self.chave == 1):
            ...
            if (response == Gtk.ResponseType.OK):
                ...
                pux = pux.hex()
                arq_ux = open('/snap/gerenciadorcs/current/bin/ux.bin', 'r')
                arq_sx = open('/snap/gerenciadorcs/current/bin/sx.bin', 'r')
                ...
                while(self.chave_nuser == 1):
                    ...
                    if response3 == Gtk.ResponseType.OK:
                        ...
                        if (nuser == "" or userp == ""):
                            ...
                            user_check = open('/snap/gerenciadorcs/current/bin/ux.bin', 'r')
                    ...
                    if (self.chave_check == 0):
                        arq_ux = open('/snap/gerenciadorcs/current/bin/ux.bin', 'a+')
                        arq_sx = open('/snap/gerenciadorcs/current/bin/sx.bin', 'a+')
                        arq_ux.write("{}\n".format(nuser))
                        arq_sx.write("{}\n".format(userp))
                        arq_ux.seek(0)
                        arq_sx.seek(0)
    ...
    def on_botao_gravar_registro_clicked(self, object, data=None):
        ...
        arq_ac = open('/snap/gerenciadorcs/current/bin/ac.bin', 'a+')
        arq_ac.write("{}\n".format(conta_name))
        arq_ac.seek(0)
        arq_ac.close()
        arq_nu = open('/snap/gerenciadorcs/current/bin/nu.bin', 'a+')
        arq_nu.write("{}\n".format(nome_usuario))
        arq_nu.seek(0)
        arq_nu.close()
        arq_se = open('/snap/gerenciadorcs/current/bin/se.bin', 'a+')
        arq_se.write("{}\n".format(conta_ps))
        arq_se.seek(0)
        arq_se.close()
        arq_asu = open('/snap/gerenciadorcs/current/bin/asu.bin', 'a+')
        arq_asu.write("{}\n".format(self.aux))
        arq_asu.seek(0)
        arq_asu.close()
    ...
    def on_botao_exibir_clicked(self, object, data=None):
        ...
        arq_ac = open('/snap/gerenciadorcs/current/bin/ac.bin', 'r')
        iac = 0
        for linha in arq_ac:
            linha = linha.rstrip()
            a = linha
        ...
        arq_nu = open('/snap/gerenciadorcs/current/bin/nu.bin', 'r')
        inu = 0
        for linha in arq_nu:
            linha = linha.rstrip()
            e = linha
        ...
        arq_se = open('/snap/gerenciadorcs/current/bin/se.bin', 'r')
        ise = 0
        for linha in arq_se:
            linha = linha.rstrip()
            b = linha
        ...
        arq_asu = open('/snap/gerenciadorcs/current/bin/asu.bin', 'r')
        iasu = 0
        counter = 0
    ...
    def on_botao_confirmar_alteracao_clicked(self, object, data=None):
        ...
        if (senha_nova == ""):
            ...
            if (chave_alterar > 0):
                arq_c = open('/snap/gerenciadorcs/current/bin/ac.bin', 'w')
                arq_c.write('')
                arq_c.close()
                arq_c = open('/snap/gerenciadorcs/current/bin/ac.bin', 'a+')
                ...
                arq_n = open('/snap/gerenciadorcs/current/bin/nu.bin', 'w')
                arq_n.write('')
                arq_n.close()
                arq_n = open('/snap/gerenciadorcs/current/bin/nu.bin', 'a+')
                ...
                arq_s = open('/snap/gerenciadorcs/current/bin/se.bin', 'w')
                arq_s.write('')
                arq_s.close()
                arq_s = open('/snap/gerenciadorcs/current/bin/se.bin', 'a+')
