...
class main_window:
        ...
        while (self.chave == 1):
            ...
            if (response == Gtk.ResponseType.OK):
                ...
                if (cux == csx):
                    ...
                    self.dialogo_c(self.dialogo, self.rotulo, mlogin1)
                    self.login.hide()
                    ...
                    self.dialogo_c(self.dialogo, self.rotulo, mlogin2)                    
                ...
                while(self.chave_nuser == 1):
                    ...
                    if response3 == Gtk.ResponseType.OK:
                        ...
                        if (nuser == "" or userp == ""):
                            ...
                            self.dialogo_c(self.dialogo, self.rotulo, mnuser1)
                            ad = nuser
                        else:
                    ...
                    if (self.chave_check == 1):
                        ...
                        self.dialogo_c(self.dialogo, self.rotulo, mnuser2)
                        self.user_name.set_text("")
                        self.user_p.set_text("")
                        ad = ""
                        nuser = ""
                    ...
                    if (self.chave_check == 0):
                        ...
                        self.dialogo_c(self.dialogo, self.rotulo, mnuser3)
                        self.user_name.set_text("")
                        self.user_p.set_text("")
                        self.new_user.hide()
                        self.chave_nuser = 0
    ...
    def on_botao_gravar_registro_clicked(self, object, data=None):
        ...
        if (conta_name == "" or nome_usuario == "" or conta_ps == ""):
            ...
            if (msg_gravar == "Dados Gravados com Sucesso"):
